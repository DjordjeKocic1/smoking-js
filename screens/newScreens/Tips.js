    ...
    >
      ...
      <View>
        ...
        <Text style={[styles.tipsHeaderText, { fontSize: 12, marginTop: 10 }]}>
          ...
          through withdrawal. Line up support in advance. Ask your doctor about
          all the methods that will help, such as quit-smoking classes and apps,
          counseling, medication, and hypnosis. You’ll be ready for the day you
          choose to quit.
        </Text>
      </View>
      ...
      <View style={{ marginTop: 20 }}>
        <Text style={styles.tipsHeaderText}>7. Try relaxation techniques.</Text>
        <Text style={[styles.tipsHeaderText, { fontSize: 12, marginTop: 10 }]}>
      ...
      <View style={{ marginTop: 20 }}>
        ...
        <Text style={[styles.tipsHeaderText, { fontSize: 12, marginTop: 10 }]}>
          ...
          tobacco cravings. These reasons might include: Feeling better,Getting
