    ...
    >
      ...
      <View style={styles.tipsContainer}>
        <Text style={styles.tipsContainerText}>
          ...
          public smoke-free zone. These simple tricks may be enough to move you
          past your tobacco craving.
        </Text>
      </View>
      <View style={styles.tipsContainer}>
        <Text style={styles.tipsContainerText}>
          3. <Text style={{ color: "#c39351" }}>Give your mouth something</Text>{" "}
      ...
      <View style={styles.tipsContainer}>
        <Text style={styles.tipsContainerText}>
          6. Write down or say out loud why you want to stop smoking and resist
          tobacco cravings. These reasons might include:{" "}
